...
"""));
        ...
        _log.Info($"[TIKTOK_IDENTITY_UPDATE_SAVED] name={nameChanged} avatar={avatarChanged} bio={bioChanged} cooldown=false finalConfirm={saveConfirmPresent} fastNameGuard={fastNameGuardMode} skipPostSaveNameVerify={skipPostSaveNameVerification}");
        ...
        return new TikTokProfileIdentityUpdateResult(
            ...
            fastNameGuardMode || skipPostSaveNameVerification
                ? "Đã lưu thao tác thành công: " + message
                : "Đã xử lý và xác minh: " + message);
    }
